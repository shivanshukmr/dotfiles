...
let s:t_Co = has('gui_running') ? -1 : get(g:, 'gruvbox_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
let s:italics = get(g:, 'gruvbox_italics', get(g:, 'gruvbox_italic', 1))
...
if &background ==# 'dark'
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi Terminal guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
    hi VertSplit guifg=#665c54 guibg=NONE gui=NONE cterm=NONE
  else
    hi Normal guifg=#ebdbb2 guibg=#121212 gui=NONE cterm=NONE
    hi CursorLineNr guifg=#fabd2f guibg=#171a1b gui=NONE cterm=NONE
    hi FoldColumn guifg=#928374 guibg=#171a1b gui=NONE cterm=NONE
    hi SignColumn guifg=#ebdbb2 guibg=#171a1b gui=NONE cterm=NONE
    hi Terminal guifg=#ebdbb2 guibg=#121212 gui=NONE cterm=NONE
    hi VertSplit guifg=#665c54 guibg=#121212 gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg=#171a1b gui=NONE cterm=NONE
  hi Comment guifg=#928374 guibg=NONE gui=italic cterm=italic
  hi CursorLine guifg=NONE guibg=#171a1b gui=NONE cterm=NONE
  hi Error guifg=#d75f5f guibg=#121212 gui=bold,reverse cterm=bold,reverse
  hi ErrorMsg guifg=#121212 guibg=#d75f5f gui=bold cterm=bold
  hi Folded guifg=#928374 guibg=#171a1b gui=italic cterm=italic
  hi LineNr guifg=#7c6f64 guibg=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=NONE guibg=#413a36 gui=bold,underline cterm=bold,underline
  hi NonText guifg=#413a36 guibg=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#7c6f64 guibg=#171a1b gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#171a1b gui=NONE cterm=NONE
  hi PmenuSel guifg=#121212 guibg=#83a598 gui=bold cterm=bold
  hi PmenuThumb guifg=NONE guibg=#7c6f64 gui=NONE cterm=NONE
  hi SpecialKey guifg=#928374 guibg=NONE gui=NONE cterm=NONE
  hi StatusLine guifg=#413a36 guibg=#ebdbb2 gui=reverse cterm=reverse
  hi StatusLineNC guifg=#171a1b guibg=#a89984 gui=reverse cterm=reverse
  hi TabLine guifg=#7c6f64 guibg=#171a1b gui=NONE cterm=NONE
  hi TabLineFill guifg=#7c6f64 guibg=#171a1b gui=NONE cterm=NONE
  hi TabLineSel guifg=#b8bb26 guibg=#171a1b gui=NONE cterm=NONE
  hi ToolbarButton guifg=#fbf1c7 guibg=#665c54 gui=bold cterm=bold
  hi ToolbarLine guifg=NONE guibg=#665c54 gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#413a36 gui=NONE cterm=NONE
  hi WildMenu guifg=#83a598 guibg=#413a36 gui=bold cterm=bold
  hi Conceal guifg=#83a598 guibg=NONE gui=NONE cterm=NONE
  hi Cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi DiffAdd guifg=#b8bb26 guibg=#121212 gui=reverse cterm=reverse
  hi DiffChange guifg=#8ec07c guibg=#121212 gui=reverse cterm=reverse
  hi DiffDelete guifg=#d75f5f guibg=#121212 gui=reverse cterm=reverse
  hi DiffText guifg=#fabd2f guibg=#121212 gui=reverse cterm=reverse
  hi Directory guifg=#b8bb26 guibg=NONE gui=bold cterm=bold
  hi IncSearch guifg=#fe8019 guibg=#121212 gui=reverse cterm=reverse
  ...
  hi Search guifg=#fabd2f guibg=#121212 gui=reverse cterm=reverse
  hi SpellBad guifg=#d75f5f guibg=NONE guisp=#d75f5f gui=italic,undercurl cterm=italic,underline
  ...
  hi Keyword guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  hi Label guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  ...
  hi Repeat guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  hi SpecialChar guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  hi SpecialComment guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  hi Statement guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  ...
  hi DiagnosticError guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticWarn guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticInfo guifg=#83a598 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticHint guifg=#a89984 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticOk guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticUnnecessary guifg=#928374 guibg=NONE gui=underline cterm=underline
  hi DiagnosticVirtualTextError guifg=#d75f5f guibg=#171a1b gui=italic cterm=italic
  hi DiagnosticVirtualTextWarn guifg=#fe8019 guibg=#171a1b gui=italic cterm=italic
  hi DiagnosticVirtualTextInfo guifg=#83a598 guibg=#171a1b gui=italic cterm=italic
  hi DiagnosticVirtualTextHint guifg=#a89984 guibg=#171a1b gui=italic cterm=italic
  hi DiagnosticVirtualTextOk guifg=#ebdbb2 guibg=#171a1b gui=italic cterm=italic
  hi DiagnosticVirtualLinesError guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesWarn guifg=#fe8019 guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesInfo guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesHint guifg=#a89984 guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesOk guifg=#ebdbb2 guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticUnderlineError guifg=#d75f5f guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineWarn guifg=#fe8019 guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineInfo guifg=#83a598 guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineHint guifg=#a89984 guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineOk guifg=#ebdbb2 guibg=NONE gui=underline cterm=underline
  hi DiagnosticSignError guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticSignWarn guifg=#fe8019 guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticSignInfo guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticSignHint guifg=#a89984 guibg=#171a1b gui=NONE cterm=NONE
  hi DiagnosticSignOk guifg=#ebdbb2 guibg=#171a1b gui=NONE cterm=NONE
  if !s:italics
    ...
    hi DiagnosticVirtualTextError gui=NONE cterm=NONE
    hi DiagnosticVirtualTextWarn gui=NONE cterm=NONE
    hi DiagnosticVirtualTextInfo gui=NONE cterm=NONE
    hi DiagnosticVirtualTextHint gui=NONE cterm=NONE
    hi DiagnosticVirtualTextOk gui=NONE cterm=NONE
  endif
  if has('nvim')
    hi @text.strong guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
    hi @text.strike guifg=NONE guibg=NONE gui=strikethrough ctermfg=NONE ctermbg=NONE cterm=strikethrough
    hi @text.emphasis guifg=NONE guibg=NONE gui=italic ctermfg=NONE ctermbg=NONE cterm=italic
    hi @text.underline guifg=NONE guibg=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
    if !s:italics
  ...
  hi NormalMode guifg=#a89984 guibg=#121212 gui=reverse cterm=reverse
  hi InsertMode guifg=#83a598 guibg=#121212 gui=reverse cterm=reverse
  hi ReplaceMode guifg=#8ec07c guibg=#121212 gui=reverse cterm=reverse
  hi VisualMode guifg=#fe8019 guibg=#121212 gui=reverse cterm=reverse
  hi CommandMode guifg=#d3869b guibg=#121212 gui=reverse cterm=reverse
  hi Warnings guifg=#fe8019 guibg=#121212 gui=reverse cterm=reverse
  hi! link TermCursor Cursor
  hi TermCursorNC guifg=#171a1b guibg=#ebdbb2 gui=NONE cterm=NONE
  if get(g:, "gruvbox_plugin_hi_groups", 1)
    hi ALEError guifg=NONE guibg=NONE guisp=#d75f5f gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi ALEWarning guifg=NONE guibg=NONE guisp=#d75f5f gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi ALEInfo guifg=NONE guibg=NONE guisp=#83a598 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi ALEErrorSign guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
    hi ALEWarningSign guifg=#fabd2f guibg=#171a1b gui=NONE cterm=NONE
    hi ALEInfoSign guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi BufTabLineCurrent guifg=#121212 guibg=#a89984 gui=NONE cterm=NONE
    hi BufTabLineActive guifg=#a89984 guibg=#413a36 gui=NONE cterm=NONE
    hi BufTabLineHidden guifg=#7c6f64 guibg=#171a1b gui=NONE cterm=NONE
    hi BufTabLineFill guifg=#121212 guibg=#121212 gui=NONE cterm=NONE
    hi CocErrorSign guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
    hi CocWarningSign guifg=#fe8019 guibg=#171a1b gui=NONE cterm=NONE
    hi CocInfoSign guifg=#fabd2f guibg=#171a1b gui=NONE cterm=NONE
    hi CocHintSign guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi CocErrorFloat guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi CtrlPNoEntries guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi CtrlPPrtBase guifg=#413a36 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPPrtCursor guifg=#83a598 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPLinePre guifg=#413a36 guibg=NONE gui=NONE cterm=NONE
    hi CtrlPMode1 guifg=#83a598 guibg=#413a36 gui=bold cterm=bold
    hi CtrlPMode2 guifg=#121212 guibg=#83a598 gui=bold cterm=bold
    hi CtrlPStats guifg=#a89984 guibg=#413a36 gui=bold cterm=bold
    if !get(g:, 'gruvbox_bold', 1)
    ...
    hi gitcommitDiscardedFile guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    if get(g:, 'gruvbox_transp_bg', 0)
      ...
      hi GitGutterDelete guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
      hi GitGutterChangeDelete guifg=#8ec07c guibg=NONE gui=NONE cterm=NONE
    else
      hi GitGutterAdd guifg=#b8bb26 guibg=#171a1b gui=NONE cterm=NONE
      hi GitGutterChange guifg=#8ec07c guibg=#171a1b gui=NONE cterm=NONE
      hi GitGutterDelete guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
      hi GitGutterChangeDelete guifg=#8ec07c guibg=#171a1b gui=NONE cterm=NONE
    endif
    if get(g:, 'indent_guides_auto_colors', 0)
      if get(g:, 'gruvbox_invert_indent_guides', 0)
        hi IndentGuidesOdd guifg=#121212 guibg=#413a36 gui=reverse cterm=reverse
        hi IndentGuidesEven guifg=#121212 guibg=#171a1b gui=reverse cterm=reverse
      else
        hi IndentGuidesOdd guifg=#121212 guibg=#413a36 gui=NONE cterm=NONE
        hi IndentGuidesEven guifg=#121212 guibg=#171a1b gui=NONE cterm=NONE
      endif
    endif
    ...
    if !exists('g:indentLine_color_gui')
      let g:indentLine_color_gui = '#413a36'
    endif
    hi LspDiagnosticsDefaultError guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi LspDiagnosticsSignError guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
    ...
    hi LspDiagnosticsSignWarning guifg=#fe8019 guibg=#171a1b gui=NONE cterm=NONE
    ...
    hi LspDiagnosticsSignInformation guifg=#fabd2f guibg=#171a1b gui=NONE cterm=NONE
    ...
    hi LspDiagnosticsSignHint guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi LspDiagnosticsUnderlineHint guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LanguageClientError guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi LanguageClientErrorSign guifg=#d75f5f guibg=#121212 gui=NONE cterm=NONE
    hi LanguageClientWarning guifg=#fabd2f guibg=NONE gui=NONE cterm=NONE
    hi LanguageClientWarningSign guifg=#fabd2f guibg=#171a1b gui=NONE cterm=NONE
    hi LangaugeClientInfo guifg=#83a598 guibg=NONE gui=NONE cterm=NONE
    hi LanguageClientInfoSign guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    ...
    hi NERDTreeToggleOff guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi ShowMarksHLl guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi ShowMarksHLu guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi ShowMarksHLo guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi ShowMarksHLm guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi SignifySignAdd guifg=#b8bb26 guibg=#171a1b gui=NONE cterm=NONE
    hi SignifySignChange guifg=#8ec07c guibg=#171a1b gui=NONE cterm=NONE
    hi SignifySignDelete guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
    hi SignatureMarkText guifg=#83a598 guibg=#171a1b gui=NONE cterm=NONE
    hi SignatureMarkerText guifg=#d3869b guibg=#171a1b gui=NONE cterm=NONE
    ...
    hi StartifySpecial guifg=#413a36 guibg=NONE gui=NONE cterm=NONE
    hi StartifyHeader guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
    hi StartifyFooter guifg=#413a36 guibg=NONE gui=NONE cterm=NONE
    hi SyntasticError guifg=NONE guibg=NONE guisp=#d75f5f gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SyntasticWarning guifg=NONE guibg=NONE guisp=#fabd2f gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SyntasticErrorSign guifg=#d75f5f guibg=#171a1b gui=NONE cterm=NONE
    hi SyntasticWarningSign guifg=#fabd2f guibg=#171a1b gui=NONE cterm=NONE
    hi multiple_cursors_cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
    hi multiple_cursors_visual guifg=NONE guibg=#413a36 gui=NONE cterm=NONE
    let g:vimshell_escape_colors = [
          \ '#7c6f64', '#d75f5f', '#b8bb26', '#fabd2f',
          \ '#83a598', '#d3869b', '#8ec07c', '#a89984',
          \ '#121212', '#d75f5f', '#b8bb26', '#fe8019',
  ...
  if get(g:, "gruvbox_filetype_hi_groups", 1)
    ...
    hi clojureException guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi pythonDecorator guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi pythonOperator guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi pythonException guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi pythonConditional guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi pythonRepeat guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi javaScriptIdentifier guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi javascriptOperator guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi javascriptForOperator guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi javascriptYield guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi javascriptExceptions guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi javascriptMessage guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi javascriptAsyncFuncKeyword guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi javascriptAwaitFuncKeyword guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi jsImport guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi jsExport guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi jsFrom guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi jsClassKeyword guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi jsClassProperty guifg=#b8bb26 guibg=NONE gui=NONE cterm=NONE
    hi jsExtendsKeyword guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi jsBracket guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi jsObjectColon guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi objcTypeModifier guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    ...
    hi scalaKeyword guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
    hi scalaKeywordModifier guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi Terminal guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi VertSplit guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
  else
    hi Normal guifg=#3c3836 guibg=#f2e5bc gui=NONE cterm=NONE
    ...
    hi Terminal guifg=#3c3836 guibg=#f2e5bc gui=NONE cterm=NONE
    hi VertSplit guifg=#bdae93 guibg=#f2e5bc gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg=#ebdbb2 gui=NONE cterm=NONE
  hi Comment guifg=#928374 guibg=NONE gui=italic cterm=italic
  hi CursorLine guifg=NONE guibg=#ebdbb2 gui=NONE cterm=NONE
  hi Error guifg=#9d0006 guibg=#f2e5bc gui=bold,reverse cterm=bold,reverse
  hi ErrorMsg guifg=#f2e5bc guibg=#9d0006 gui=bold cterm=bold
  ...
  hi Pmenu guifg=#a89984 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#ebdbb2 gui=NONE cterm=NONE
  hi PmenuSel guifg=#f2e5bc guibg=#076678 gui=bold cterm=bold
  ...
  hi Visual guifg=NONE guibg=#d5c4a1 gui=NONE cterm=NONE
  hi WildMenu guifg=#076678 guibg=#d5c4a1 gui=bold cterm=bold
  hi Conceal guifg=#076678 guibg=NONE gui=NONE cterm=NONE
  hi Cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi DiffAdd guifg=#79740e guibg=#f2e5bc gui=reverse cterm=reverse
  hi DiffChange guifg=#427b58 guibg=#f2e5bc gui=reverse cterm=reverse
  hi DiffDelete guifg=#9d0006 guibg=#f2e5bc gui=reverse cterm=reverse
  hi DiffText guifg=#b57614 guibg=#f2e5bc gui=reverse cterm=reverse
  hi Directory guifg=#79740e guibg=NONE gui=bold cterm=bold
  hi IncSearch guifg=#af3a03 guibg=#f2e5bc gui=reverse cterm=reverse
  ...
  hi Search guifg=#b57614 guibg=#f2e5bc gui=reverse cterm=reverse
  ...
  hi Todo guifg=fg guibg=#f2e5bc gui=bold,italic cterm=bold,italic
  ...
  hi CursorIM guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi DiagnosticError guifg=#9d0006 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticWarn guifg=#af3a03 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticInfo guifg=#076678 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticHint guifg=#7c6f64 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticOk guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
  hi DiagnosticUnnecessary guifg=#928374 guibg=NONE gui=underline cterm=underline
  hi DiagnosticVirtualTextError guifg=#9d0006 guibg=#ebdbb2 gui=italic cterm=italic
  hi DiagnosticVirtualTextWarn guifg=#af3a03 guibg=#ebdbb2 gui=italic cterm=italic
  hi DiagnosticVirtualTextInfo guifg=#076678 guibg=#ebdbb2 gui=italic cterm=italic
  hi DiagnosticVirtualTextHint guifg=#7c6f64 guibg=#ebdbb2 gui=italic cterm=italic
  hi DiagnosticVirtualTextOk guifg=#3c3836 guibg=#ebdbb2 gui=italic cterm=italic
  hi DiagnosticVirtualLinesError guifg=#9d0006 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesWarn guifg=#af3a03 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesInfo guifg=#076678 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesHint guifg=#7c6f64 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticVirtualLinesOk guifg=#3c3836 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticUnderlineError guifg=#9d0006 guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineWarn guifg=#af3a03 guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineInfo guifg=#076678 guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineHint guifg=#7c6f64 guibg=NONE gui=underline cterm=underline
  hi DiagnosticUnderlineOk guifg=#3c3836 guibg=NONE gui=underline cterm=underline
  hi DiagnosticSignError guifg=#9d0006 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticSignWarn guifg=#af3a03 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticSignInfo guifg=#076678 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticSignHint guifg=#7c6f64 guibg=#ebdbb2 gui=NONE cterm=NONE
  hi DiagnosticSignOk guifg=#3c3836 guibg=#ebdbb2 gui=NONE cterm=NONE
  if !s:italics
    hi Comment gui=NONE cterm=NONE
    hi Folded gui=NONE cterm=NONE
    hi SpellBad gui=undercurl cterm=underline
  ...
  hi NormalMode guifg=#7c6f64 guibg=#f2e5bc gui=reverse cterm=reverse
  hi InsertMode guifg=#076678 guibg=#f2e5bc gui=reverse cterm=reverse
  hi ReplaceMode guifg=#427b58 guibg=#f2e5bc gui=reverse cterm=reverse
  hi VisualMode guifg=#af3a03 guibg=#f2e5bc gui=reverse cterm=reverse
  hi CommandMode guifg=#8f3f71 guibg=#f2e5bc gui=reverse cterm=reverse
  hi Warnings guifg=#af3a03 guibg=#f2e5bc gui=reverse cterm=reverse
  hi! link TermCursor Cursor
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 1)
    ...
    hi BufTabLineCurrent guifg=#f2e5bc guibg=#7c6f64 gui=NONE cterm=NONE
    ...
    hi BufTabLineFill guifg=#f2e5bc guibg=#f2e5bc gui=NONE cterm=NONE
    ...
    hi CtrlPMode2 guifg=#f2e5bc guibg=#076678 gui=bold cterm=bold
    ...
    if get(g:, 'indent_guides_auto_colors', 0)
      if get(g:, 'gruvbox_invert_indent_guides', 0)
        hi IndentGuidesOdd guifg=#f2e5bc guibg=#d5c4a1 gui=reverse cterm=reverse
        hi IndentGuidesEven guifg=#f2e5bc guibg=#ebdbb2 gui=reverse cterm=reverse
      else
        hi IndentGuidesOdd guifg=#f2e5bc guibg=#d5c4a1 gui=NONE cterm=NONE
        hi IndentGuidesEven guifg=#f2e5bc guibg=#ebdbb2 gui=NONE cterm=NONE
      endif
    endif
    if !exists('g:indentLine_color_term')
    ...
    hi LanguageClientErrorSign guifg=#9d0006 guibg=#f2e5bc gui=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_filetype_hi_groups", 1)
    ...
    hi htmlBold guifg=fg guibg=#f2e5bc gui=bold cterm=bold
    hi htmlBoldUnderline guifg=fg guibg=#f2e5bc gui=bold,underline cterm=bold,underline
    hi htmlBoldItalic guifg=fg guibg=#f2e5bc gui=bold,italic cterm=bold,italic
    hi htmlBoldUnderlineItalic guifg=fg guibg=#f2e5bc gui=bold,italic,underline cterm=bold,italic,underline
    hi htmlUnderline guifg=fg guibg=#f2e5bc gui=underline cterm=underline
    hi htmlUnderlineItalic guifg=fg guibg=#f2e5bc gui=italic,underline cterm=italic,underline
    hi htmlItalic guifg=fg guibg=#f2e5bc gui=italic cterm=italic
...
if s:t_Co >= 256
  if &background ==# 'dark'
    if get(g:, 'gruvbox_transp_bg', 0)
      ...
      hi CursorLineNr ctermfg=214 ctermbg=234 cterm=NONE
      hi FoldColumn ctermfg=102 ctermbg=234 cterm=NONE
      hi SignColumn ctermfg=187 ctermbg=234 cterm=NONE
    ...
    hi DiagnosticWarn ctermfg=208 ctermbg=NONE cterm=NONE
    hi DiagnosticInfo ctermfg=109 ctermbg=NONE cterm=NONE
    hi DiagnosticHint ctermfg=137 ctermbg=NONE cterm=NONE
    hi DiagnosticOk ctermfg=187 ctermbg=NONE cterm=NONE
    hi DiagnosticUnnecessary ctermfg=102 ctermbg=NONE cterm=underline
    hi DiagnosticVirtualTextError ctermfg=203 ctermbg=234 cterm=italic
    hi DiagnosticVirtualTextWarn ctermfg=208 ctermbg=234 cterm=italic
    hi DiagnosticVirtualTextInfo ctermfg=109 ctermbg=234 cterm=italic
    hi DiagnosticVirtualTextHint ctermfg=137 ctermbg=234 cterm=italic
    hi DiagnosticVirtualTextOk ctermfg=187 ctermbg=234 cterm=italic
    hi DiagnosticVirtualLinesError ctermfg=203 ctermbg=234 cterm=NONE
    hi DiagnosticVirtualLinesWarn ctermfg=208 ctermbg=234 cterm=NONE
    hi DiagnosticVirtualLinesInfo ctermfg=109 ctermbg=234 cterm=NONE
    hi DiagnosticVirtualLinesHint ctermfg=137 ctermbg=234 cterm=NONE
    hi DiagnosticVirtualLinesOk ctermfg=187 ctermbg=234 cterm=NONE
    hi DiagnosticUnderlineError ctermfg=203 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineWarn ctermfg=208 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineInfo ctermfg=109 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineHint ctermfg=137 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineOk ctermfg=187 ctermbg=NONE cterm=underline
    hi DiagnosticSignError ctermfg=203 ctermbg=234 cterm=NONE
    hi DiagnosticSignWarn ctermfg=208 ctermbg=234 cterm=NONE
    hi DiagnosticSignInfo ctermfg=109 ctermbg=234 cterm=NONE
    hi DiagnosticSignHint ctermfg=137 ctermbg=234 cterm=NONE
    hi DiagnosticSignOk ctermfg=187 ctermbg=234 cterm=NONE
    if !s:italics
      ...
      hi Todo cterm=bold
      hi DiagnosticVirtualTextError cterm=NONE
      hi DiagnosticVirtualTextWarn cterm=NONE
      hi DiagnosticVirtualTextInfo cterm=NONE
      hi DiagnosticVirtualTextHint cterm=NONE
      hi DiagnosticVirtualTextOk cterm=NONE
    endif
    if has('nvim')
      hi @text.strong ctermfg=NONE ctermbg=NONE cterm=bold
      hi @text.strike ctermfg=NONE ctermbg=NONE cterm=strikethrough
      hi @text.emphasis ctermfg=NONE ctermbg=NONE cterm=italic
      hi @text.underline ctermfg=NONE ctermbg=NONE cterm=underline
      if !s:italics
    ...
    hi! link TermCursor Cursor
    hi TermCursorNC ctermfg=234 ctermbg=187 cterm=NONE
    if get(g:, "gruvbox_plugin_hi_groups", 1)
      ...
      hi ALEErrorSign ctermfg=203 ctermbg=234 cterm=NONE
      hi ALEWarningSign ctermfg=214 ctermbg=234 cterm=NONE
      hi ALEInfoSign ctermfg=109 ctermbg=234 cterm=NONE
      hi BufTabLineCurrent ctermfg=234 ctermbg=137 cterm=NONE
      hi BufTabLineActive ctermfg=137 ctermbg=239 cterm=NONE
      hi BufTabLineHidden ctermfg=243 ctermbg=234 cterm=NONE
      hi BufTabLineFill ctermfg=234 ctermbg=234 cterm=NONE
      hi CocErrorSign ctermfg=203 ctermbg=234 cterm=NONE
      hi CocWarningSign ctermfg=208 ctermbg=234 cterm=NONE
      hi CocInfoSign ctermfg=214 ctermbg=234 cterm=NONE
      hi CocHintSign ctermfg=109 ctermbg=234 cterm=NONE
      ...
      if get(g:, 'gruvbox_transp_bg', 0)
        ...
        hi GitGutterAdd ctermfg=142 ctermbg=234 cterm=NONE
        hi GitGutterChange ctermfg=107 ctermbg=234 cterm=NONE
        hi GitGutterDelete ctermfg=203 ctermbg=234 cterm=NONE
        hi GitGutterChangeDelete ctermfg=107 ctermbg=234 cterm=NONE
      endif
      if get(g:, 'indent_guides_auto_colors', 0)
        if get(g:, 'gruvbox_invert_indent_guides', 0)
          hi IndentGuidesOdd ctermfg=234 ctermbg=239 cterm=reverse
          hi IndentGuidesEven ctermfg=234 ctermbg=234 cterm=reverse
        else
          hi IndentGuidesOdd ctermfg=234 ctermbg=239 cterm=NONE
          hi IndentGuidesEven ctermfg=234 ctermbg=234 cterm=NONE
        endif
      endif
      if !exists('g:indentLine_color_term')
        let g:indentLine_color_term = 239
      ...
      hi LspDiagnosticsSignWarning ctermfg=208 ctermbg=234 cterm=NONE
      ...
      hi LspDiagnosticsSignInformation ctermfg=214 ctermbg=234 cterm=NONE
      ...
      hi LspDiagnosticsSignHint ctermfg=109 ctermbg=234 cterm=NONE
      ...
      hi LanguageClientWarningSign ctermfg=214 ctermbg=234 cterm=NONE
      hi LangaugeClientInfo ctermfg=109 ctermbg=NONE cterm=NONE
      hi LanguageClientInfoSign ctermfg=109 ctermbg=234 cterm=NONE
      ...
      let g:niji_dark_colours = g:rbpt_colorpairs
      let g:niji_light_colours = g:rbpt_colorpairs
      hi ShowMarksHLl ctermfg=109 ctermbg=234 cterm=NONE
      hi ShowMarksHLu ctermfg=109 ctermbg=234 cterm=NONE
      hi ShowMarksHLo ctermfg=109 ctermbg=234 cterm=NONE
      hi ShowMarksHLm ctermfg=109 ctermbg=234 cterm=NONE
      hi SignifySignAdd ctermfg=142 ctermbg=234 cterm=NONE
      hi SignifySignChange ctermfg=107 ctermbg=234 cterm=NONE
      hi SignifySignDelete ctermfg=203 ctermbg=234 cterm=NONE
      hi SignatureMarkText ctermfg=109 ctermbg=234 cterm=NONE
      hi SignatureMarkerText ctermfg=175 ctermbg=234 cterm=NONE
      ...
      hi SyntasticErrorSign ctermfg=203 ctermbg=234 cterm=NONE
      hi SyntasticWarningSign ctermfg=214 ctermbg=234 cterm=NONE
    ...
    hi Pmenu ctermfg=137 ctermbg=251 cterm=NONE
    ...
    hi Visual ctermfg=NONE ctermbg=180 cterm=NONE
    ...
    hi DiagnosticWarn ctermfg=124 ctermbg=NONE cterm=NONE
    hi DiagnosticInfo ctermfg=23 ctermbg=NONE cterm=NONE
    hi DiagnosticHint ctermfg=243 ctermbg=NONE cterm=NONE
    hi DiagnosticOk ctermfg=237 ctermbg=NONE cterm=NONE
    hi DiagnosticUnnecessary ctermfg=102 ctermbg=NONE cterm=underline
    hi DiagnosticVirtualTextError ctermfg=124 ctermbg=251 cterm=italic
    hi DiagnosticVirtualTextWarn ctermfg=124 ctermbg=251 cterm=italic
    hi DiagnosticVirtualTextInfo ctermfg=23 ctermbg=251 cterm=italic
    hi DiagnosticVirtualTextHint ctermfg=243 ctermbg=251 cterm=italic
    hi DiagnosticVirtualTextOk ctermfg=237 ctermbg=251 cterm=italic
    hi DiagnosticVirtualLinesError ctermfg=124 ctermbg=251 cterm=NONE
    hi DiagnosticVirtualLinesWarn ctermfg=124 ctermbg=251 cterm=NONE
    hi DiagnosticVirtualLinesInfo ctermfg=23 ctermbg=251 cterm=NONE
    hi DiagnosticVirtualLinesHint ctermfg=243 ctermbg=251 cterm=NONE
    hi DiagnosticVirtualLinesOk ctermfg=237 ctermbg=251 cterm=NONE
    hi DiagnosticUnderlineError ctermfg=124 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineWarn ctermfg=124 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineInfo ctermfg=23 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineHint ctermfg=243 ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineOk ctermfg=237 ctermbg=NONE cterm=underline
    hi DiagnosticSignError ctermfg=124 ctermbg=251 cterm=NONE
    hi DiagnosticSignWarn ctermfg=124 ctermbg=251 cterm=NONE
    hi DiagnosticSignInfo ctermfg=23 ctermbg=251 cterm=NONE
    hi DiagnosticSignHint ctermfg=243 ctermbg=251 cterm=NONE
    hi DiagnosticSignOk ctermfg=237 ctermbg=251 cterm=NONE
    if !s:italics
      hi Comment cterm=NONE
      hi Folded cterm=NONE
      hi SpellBad cterm=underline
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 1)
      ...
      hi ALEWarning ctermfg=NONE ctermbg=NONE cterm=underline
      hi ALEInfo ctermfg=NONE ctermbg=NONE cterm=underline
      hi ALEErrorSign ctermfg=124 ctermbg=251 cterm=NONE
      hi ALEWarningSign ctermfg=172 ctermbg=251 cterm=NONE
      hi ALEInfoSign ctermfg=23 ctermbg=251 cterm=NONE
      hi BufTabLineCurrent ctermfg=187 ctermbg=243 cterm=NONE
      hi BufTabLineActive ctermfg=243 ctermbg=180 cterm=NONE
      hi BufTabLineHidden ctermfg=137 ctermbg=251 cterm=NONE
      hi BufTabLineFill ctermfg=187 ctermbg=187 cterm=NONE
      hi CocErrorSign ctermfg=124 ctermbg=251 cterm=NONE
      hi CocWarningSign ctermfg=124 ctermbg=251 cterm=NONE
      hi CocInfoSign ctermfg=172 ctermbg=251 cterm=NONE
      hi CocHintSign ctermfg=23 ctermbg=251 cterm=NONE
      ...
      hi CtrlPPrtBase ctermfg=180 ctermbg=NONE cterm=NONE
      hi CtrlPPrtCursor ctermfg=23 ctermbg=NONE cterm=NONE
      hi CtrlPLinePre ctermfg=180 ctermbg=NONE cterm=NONE
      hi CtrlPMode1 ctermfg=23 ctermbg=180 cterm=bold
      hi CtrlPMode2 ctermfg=187 ctermbg=23 cterm=bold
      hi CtrlPStats ctermfg=243 ctermbg=180 cterm=bold
      ...
      if get(g:, 'gruvbox_transp_bg', 0)
        ...
        hi GitGutterAdd ctermfg=100 ctermbg=251 cterm=NONE
        hi GitGutterChange ctermfg=29 ctermbg=251 cterm=NONE
        hi GitGutterDelete ctermfg=124 ctermbg=251 cterm=NONE
        hi GitGutterChangeDelete ctermfg=29 ctermbg=251 cterm=NONE
      endif
      if get(g:, 'indent_guides_auto_colors', 0)
        if get(g:, 'gruvbox_invert_indent_guides', 0)
          hi IndentGuidesOdd ctermfg=187 ctermbg=180 cterm=reverse
          hi IndentGuidesEven ctermfg=187 ctermbg=251 cterm=reverse
        else
          hi IndentGuidesOdd ctermfg=187 ctermbg=180 cterm=NONE
          hi IndentGuidesEven ctermfg=187 ctermbg=251 cterm=NONE
        endif
      endif
      if !exists('g:indentLine_color_term')
        let g:indentLine_color_term = 180
      ...
      hi LspDiagnosticsSignError ctermfg=124 ctermbg=251 cterm=NONE
      hi LspDiagnosticsUnderlineError ctermfg=NONE ctermbg=NONE cterm=NONE
      hi LspDiagnosticsDefaultWarning ctermfg=124 ctermbg=NONE cterm=NONE
      hi LspDiagnosticsSignWarning ctermfg=124 ctermbg=251 cterm=NONE
      hi LspDiagnosticsUnderlineWarning ctermfg=NONE ctermbg=NONE cterm=NONE
      hi LspDiagnosticsDefaultInformation ctermfg=172 ctermbg=NONE cterm=NONE
      hi LspDiagnosticsSignInformation ctermfg=172 ctermbg=251 cterm=NONE
      hi LspDiagnosticsUnderlineInformation ctermfg=NONE ctermbg=NONE cterm=NONE
      hi LspDiagnosticsDefaultHint ctermfg=23 ctermbg=NONE cterm=NONE
      hi LspDiagnosticsSignHint ctermfg=23 ctermbg=251 cterm=NONE
      hi LspDiagnosticsUnderlineHint ctermfg=NONE ctermbg=NONE cterm=NONE
      hi LanguageClientError ctermfg=124 ctermbg=NONE cterm=NONE
      hi LanguageClientErrorSign ctermfg=124 ctermbg=187 cterm=NONE
      hi LanguageClientWarning ctermfg=172 ctermbg=NONE cterm=NONE
      hi LanguageClientWarningSign ctermfg=172 ctermbg=251 cterm=NONE
      hi LangaugeClientInfo ctermfg=23 ctermbg=NONE cterm=NONE
      hi LanguageClientInfoSign ctermfg=23 ctermbg=251 cterm=NONE
      ...
      let g:niji_dark_colours = g:rbpt_colorpairs
      let g:niji_light_colours = g:rbpt_colorpairs
      hi ShowMarksHLl ctermfg=23 ctermbg=251 cterm=NONE
      hi ShowMarksHLu ctermfg=23 ctermbg=251 cterm=NONE
      hi ShowMarksHLo ctermfg=23 ctermbg=251 cterm=NONE
      hi ShowMarksHLm ctermfg=23 ctermbg=251 cterm=NONE
      hi SignifySignAdd ctermfg=100 ctermbg=251 cterm=NONE
      hi SignifySignChange ctermfg=29 ctermbg=251 cterm=NONE
      hi SignifySignDelete ctermfg=124 ctermbg=251 cterm=NONE
      hi SignatureMarkText ctermfg=23 ctermbg=251 cterm=NONE
      hi SignatureMarkerText ctermfg=126 ctermbg=251 cterm=NONE
      ...
      hi StartifySpecial ctermfg=180 ctermbg=NONE cterm=NONE
      hi StartifyHeader ctermfg=124 ctermbg=NONE cterm=NONE
      hi StartifyFooter ctermfg=180 ctermbg=NONE cterm=NONE
      hi SyntasticError ctermfg=NONE ctermbg=NONE cterm=underline
      hi SyntasticWarning ctermfg=NONE ctermbg=NONE cterm=underline
      hi SyntasticErrorSign ctermfg=124 ctermbg=251 cterm=NONE
      hi SyntasticWarningSign ctermfg=172 ctermbg=251 cterm=NONE
      hi multiple_cursors_cursor ctermfg=NONE ctermbg=NONE cterm=reverse
      hi multiple_cursors_visual ctermfg=NONE ctermbg=180 cterm=NONE
      let g:vimshell_escape_colors = [
            \ '#a89984', '#9d0006', '#79740e', '#b57614',
            \ '#076678', '#8f3f71', '#427b58', '#7c6f64',
            \ '#f2e5bc', '#9d0006', '#79740e', '#af3a03',
    ...
    if get(g:, "gruvbox_filetype_hi_groups", 1)
      ...
      hi htmlBold ctermfg=fg ctermbg=187 cterm=bold
      hi htmlBoldUnderline ctermfg=fg ctermbg=187 cterm=bold,underline
      hi htmlBoldItalic ctermfg=fg ctermbg=187 cterm=bold,italic
      hi htmlBoldUnderlineItalic ctermfg=fg ctermbg=187 cterm=bold,italic,underline
      hi htmlUnderline ctermfg=fg ctermbg=187 cterm=underline
      hi htmlUnderlineItalic ctermfg=fg ctermbg=187 cterm=italic,underline
      hi htmlItalic ctermfg=fg ctermbg=187 cterm=italic
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi DiagnosticWarn ctermfg=Magenta ctermbg=NONE cterm=NONE
    hi DiagnosticInfo ctermfg=Blue ctermbg=NONE cterm=NONE
    hi DiagnosticHint ctermfg=Gray ctermbg=NONE cterm=NONE
    hi DiagnosticOk ctermfg=White ctermbg=NONE cterm=NONE
    hi DiagnosticUnnecessary ctermfg=DarkGray ctermbg=NONE cterm=underline
    hi DiagnosticVirtualTextError ctermfg=Red ctermbg=DarkGray cterm=italic
    hi DiagnosticVirtualTextWarn ctermfg=Magenta ctermbg=DarkGray cterm=italic
    hi DiagnosticVirtualTextInfo ctermfg=Blue ctermbg=DarkGray cterm=italic
    hi DiagnosticVirtualTextHint ctermfg=Gray ctermbg=DarkGray cterm=italic
    hi DiagnosticVirtualTextOk ctermfg=White ctermbg=DarkGray cterm=italic
    hi DiagnosticVirtualLinesError ctermfg=Red ctermbg=DarkGray cterm=NONE
    hi DiagnosticVirtualLinesWarn ctermfg=Magenta ctermbg=DarkGray cterm=NONE
    hi DiagnosticVirtualLinesInfo ctermfg=Blue ctermbg=DarkGray cterm=NONE
    hi DiagnosticVirtualLinesHint ctermfg=Gray ctermbg=DarkGray cterm=NONE
    hi DiagnosticVirtualLinesOk ctermfg=White ctermbg=DarkGray cterm=NONE
    hi DiagnosticUnderlineError ctermfg=Red ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineWarn ctermfg=Magenta ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineInfo ctermfg=Blue ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineHint ctermfg=Gray ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineOk ctermfg=White ctermbg=NONE cterm=underline
    hi DiagnosticSignError ctermfg=Red ctermbg=DarkGray cterm=NONE
    hi DiagnosticSignWarn ctermfg=Magenta ctermbg=DarkGray cterm=NONE
    hi DiagnosticSignInfo ctermfg=Blue ctermbg=DarkGray cterm=NONE
    hi DiagnosticSignHint ctermfg=Gray ctermbg=DarkGray cterm=NONE
    hi DiagnosticSignOk ctermfg=White ctermbg=DarkGray cterm=NONE
    if !s:italics
      hi Comment cterm=NONE
      hi Folded cterm=NONE
      hi SpellBad cterm=underline
    ...
    hi DiagnosticWarn ctermfg=Magenta ctermbg=NONE cterm=NONE
    hi DiagnosticInfo ctermfg=Blue ctermbg=NONE cterm=NONE
    hi DiagnosticHint ctermfg=Black ctermbg=NONE cterm=NONE
    hi DiagnosticOk ctermfg=Black ctermbg=NONE cterm=NONE
    hi DiagnosticUnnecessary ctermfg=DarkGray ctermbg=NONE cterm=underline
    hi DiagnosticVirtualTextError ctermfg=Red ctermbg=Grey cterm=italic
    hi DiagnosticVirtualTextWarn ctermfg=Magenta ctermbg=Grey cterm=italic
    hi DiagnosticVirtualTextInfo ctermfg=Blue ctermbg=Grey cterm=italic
    hi DiagnosticVirtualTextHint ctermfg=Black ctermbg=Grey cterm=italic
    hi DiagnosticVirtualTextOk ctermfg=Black ctermbg=Grey cterm=italic
    hi DiagnosticVirtualLinesError ctermfg=Red ctermbg=Grey cterm=NONE
    hi DiagnosticVirtualLinesWarn ctermfg=Magenta ctermbg=Grey cterm=NONE
    hi DiagnosticVirtualLinesInfo ctermfg=Blue ctermbg=Grey cterm=NONE
    hi DiagnosticVirtualLinesHint ctermfg=Black ctermbg=Grey cterm=NONE
    hi DiagnosticVirtualLinesOk ctermfg=Black ctermbg=Grey cterm=NONE
    hi DiagnosticUnderlineError ctermfg=Red ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineWarn ctermfg=Magenta ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineInfo ctermfg=Blue ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineHint ctermfg=Black ctermbg=NONE cterm=underline
    hi DiagnosticUnderlineOk ctermfg=Black ctermbg=NONE cterm=underline
    hi DiagnosticSignError ctermfg=Red ctermbg=Grey cterm=NONE
    hi DiagnosticSignWarn ctermfg=Magenta ctermbg=Grey cterm=NONE
    hi DiagnosticSignInfo ctermfg=Blue ctermbg=Grey cterm=NONE
    hi DiagnosticSignHint ctermfg=Black ctermbg=Grey cterm=NONE
    hi DiagnosticSignOk ctermfg=Black ctermbg=Grey cterm=NONE
    if !s:italics
      hi Comment cterm=NONE
      hi Folded cterm=NONE
      hi SpellBad cterm=underline
...
" Color: bg1             rgb(23,  26,  27)     234 DarkGray
" Color: bg2             rgb(65,  58,  54)     239
...
" Color: red             rgb(215, 95,  95)     203 Red
...
" Background: light
" Color: bg0 rgb(242, 229, 188) 187 White
" Color: bg1 rgb(235, 219, 178) 251 Grey
