...
const mapping mappings[] = {
	{
		.from = {.code = KEY_A, .modifiers = {.alt = EITHER}},
		.to = {.code = KEY_A, .modifiers = {.ctrl = LEFT}},
	},
	{
...
void
write_key(__u16 code, __s32 value) {
...
bool
is_modifier(const struct input_event *event) {
	return (
 ...
 */
bool
sync_modifier(__u16 code, __s32 value) {
...
void
dispatch_mapping(const mapping *mapping) {
