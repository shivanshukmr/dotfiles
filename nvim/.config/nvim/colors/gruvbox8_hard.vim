...
" Last Updated: Fri 05 Mar 2021 09:16:47 PM IST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
      ...
      hi CursorLineNr guifg=#ebdbb2 guibg=#141718 gui=NONE cterm=NONE
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi CursorLineNr guifg=#3c3836 guibg=#f9f5d7 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    if get(g:, 'gruvbox_transp_bg', 0)
      ...
      hi CursorLineNr ctermfg=187 ctermbg=234 cterm=NONE
  ...
  if get(g:, 'gruvbox_transp_bg', 0)
    ...
    hi CursorLineNr ctermfg=237 ctermbg=229 cterm=NONE
