...
" Last Updated: Thu 08 Apr 2021 08:35:55 PM IST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
      ...
      hi CursorLineNr guifg=#ebdbb2 guibg=#282828 gui=NONE cterm=NONE
    ...
    hi LspDiagnosticsDefaultError guifg=#d75f5f guibg=NONE gui=italic cterm=italic
    hi LspDiagnosticsDefaultWarning guifg=#fe8019 guibg=NONE gui=italic cterm=italic
    hi LspDiagnosticsDefaultInformation guifg=#83a598 guibg=NONE gui=italic cterm=italic
    hi LspDiagnosticsDefaultHint guifg=#a89984 guibg=NONE gui=italic cterm=italic
    ...
    if !s:italics
      ...
      hi LspDiagnosticsDefaultError gui=NONE cterm=NONE
      hi LspDiagnosticsDefaultWarning gui=NONE cterm=NONE
      hi LspDiagnosticsDefaultInformation gui=NONE cterm=NONE
      hi LspDiagnosticsDefaultHint gui=NONE cterm=NONE
    endif
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi CursorLineNr guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi FoldColumn guifg=#928374 guibg=NONE gui=NONE cterm=NONE
    ...
    hi CursorLineNr guifg=#3c3836 guibg=#ebdbb2 gui=NONE cterm=NONE
  ...
  hi MatchParen guifg=NONE guibg=#bdae93 gui=NONE cterm=NONE
  ...
  hi LspDiagnosticsDefaultError guifg=#9d0006 guibg=NONE gui=italic cterm=italic
  hi LspDiagnosticsDefaultWarning guifg=#af3a03 guibg=NONE gui=italic cterm=italic
  hi LspDiagnosticsDefaultInformation guifg=#076678 guibg=NONE gui=italic cterm=italic
  hi LspDiagnosticsDefaultHint guifg=#7c6f64 guibg=NONE gui=italic cterm=italic
...
if s:t_Co >= 256
  if &background ==# 'dark'
    if get(g:, 'gruvbox_transp_bg', 0)
      ...
      hi CursorLineNr ctermfg=187 ctermbg=NONE cterm=NONE
      ...
      hi CursorLineNr ctermfg=187 ctermbg=237 cterm=NONE
    ...
    hi MatchParen ctermfg=NONE ctermbg=59 cterm=NONE
    ...
    hi MoreMsg ctermfg=255 ctermbg=NONE cterm=bold
    ...
    hi LspDiagnosticsDefaultError ctermfg=203 ctermbg=NONE cterm=italic
    hi LspDiagnosticsDefaultWarning ctermfg=208 ctermbg=NONE cterm=italic
    hi LspDiagnosticsDefaultInformation ctermfg=109 ctermbg=NONE cterm=italic
    hi LspDiagnosticsDefaultHint ctermfg=137 ctermbg=NONE cterm=italic
    ...
    if !s:italics
      ...
      hi Todo cterm=bold
      hi LspDiagnosticsDefaultError cterm=NONE
      hi LspDiagnosticsDefaultWarning cterm=NONE
      hi LspDiagnosticsDefaultInformation cterm=NONE
      hi LspDiagnosticsDefaultHint cterm=NONE
    endif
    if !get(g:, 'gruvbox_italicize_strings', 1)
      hi Special gui=NONE cterm=NONE
      hi String gui=NONE cterm=NONE
  ...
  if get(g:, 'gruvbox_transp_bg', 0)
    ...
    hi CursorLineNr ctermfg=237 ctermbg=251 cterm=NONE
  ...
  hi MatchParen ctermfg=NONE ctermbg=144 cterm=NONE
  ...
  hi LspDiagnosticsDefaultError ctermfg=124 ctermbg=NONE cterm=italic
  hi LspDiagnosticsDefaultWarning ctermfg=124 ctermbg=NONE cterm=italic
  hi LspDiagnosticsDefaultInformation ctermfg=23 ctermbg=NONE cterm=italic
  hi LspDiagnosticsDefaultHint ctermfg=243 ctermbg=NONE cterm=italic
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi LspDiagnosticsDefaultError ctermfg=Red ctermbg=NONE cterm=italic
    hi LspDiagnosticsDefaultWarning ctermfg=Magenta ctermbg=NONE cterm=italic
    hi LspDiagnosticsDefaultInformation ctermfg=Blue ctermbg=NONE cterm=italic
    hi LspDiagnosticsDefaultHint ctermfg=Gray ctermbg=NONE cterm=italic
  ...
  hi LspDiagnosticsDefaultWarning ctermfg=Magenta ctermbg=NONE cterm=italic
  hi LspDiagnosticsDefaultInformation ctermfg=Blue ctermbg=NONE cterm=italic
  hi LspDiagnosticsDefaultHint ctermfg=Black ctermbg=NONE cterm=italic
  hi LspDiagnosticsUnderlineError ctermfg=Red ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineWarning ctermfg=Magenta ctermbg=NONE cterm=underline
  hi LspDiagnosticsUnderlineInformation ctermfg=Blue ctermbg=NONE cterm=underline
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi MatchParen ctermfg=Gray ctermbg=NONE cterm=NONE
