...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_p     ), spawn "/usr/bin/dmenu_run -h 17 -fn \"Noto Sans-8\" -nb \"#1B2224\"")
...
myLayout = avoidStruts( tiled ||| Full )
  where
     ...
     tiled   = smartSpacingWithEdge 2 $ Tall nmaster delta ratio
...
myStartupHook = do
    spawn "/home/me/.config/polybar/launch.sh"
